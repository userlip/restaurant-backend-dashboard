        ...
        <div class="flex flex-col self-stretch gap-[1.25rem] z-10">
            ...
            <div class="flex flex-[1_0_0] flex-col gap-2 self-stretch">
              ...
              <div
                ...
                <input type="text" id="mail"
                       wire:model.debounce.750ms="phone_number"
                       class="w-full text-[1.25rem] font-thin italic leading-[150%] tracking-[0.0625rem] bg-transparent border-none outline-none"
          ...
          <button
            ...
            @session('contact_us_message')
              disabled
            @endif
            class="group mx-auto relative text-[1.4145rem] hover:text-white/80 transition-colors font-semibold flex items-center justify-center text-center w-[15.08513rem] h-[7.18738rem]">
            Sent
            <svg class="group-hover:rotate-[5deg] top-3 transition-transform absolute inset-0"
...
{{--    @endif--}}
    @if(data_get($footer, 'is_section_visible'))
      <div class="flex flex-col tablet:flex-row items-start self-stretch">
        @if(data_get($footer, 'is_left_section_visible'))
          <div
            ...
            <div class="text-center text-[#AAA] text-[0.875rem] font-thin tracking-[0.0625rem] leading-[170%]">
              {!! data_get($footer, 'subtext') !!}
            </div>
            <div class="flex justify-center items-center self-stretch">
              @foreach($links = data_get($footer, 'links') as $key => $link)
        ...
        @endif
        @if(data_get($footer, 'is_right_section_visible'))
          <div
            ...
            <div class="flex flex-col justify-center items-center gap-[0.875rem]">
              ...
              <div class="flex flex-col justify-center items-center gap-[0.25rem]">
                <span class="text-[0.5rem] font-light uppercase tracking-[0.0625rem] text-[#AAA]">
                  {{ data_get($footer, 'call_us') }}
                </span>
                <span class="text-[1rem] font-semibold">
                  {{ data_get($footer, 'phone_number') }}
                </span>
                <span class="font-light text-[#AAA] text-[0.625rem] tracking-[0.0625rem]">
                  {!! data_get($footer, 'operation_hours') !!}
                </span>
              </div>
            </div>
            <svg class="tablet:hidden" xmlns="http://www.w3.org/2000/svg" width="365" height="2" viewBox="0 0 365 2"
            ...
            <div class="flex gap-[1rem]">
              @if($facebook = data_get($footer, 'facebook'))
                <a href="{{ $facebook }}"
                   class="border border-1 hover:bg-white/20 transition-colors rounded-full p-[11px] gap-[10px] border-white/20">
                  <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
                    <path
              ...
              @endif
              @if($twitter = data_get($footer, 'twitter'))
                <a href="{{ $twitter }}"
                   target='_blank'
                 class="border border-1 hover:bg-white/20 transition-colors rounded-full p-[11px] gap-[10px] border-white/20">
                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
              ...
              @endif
              @if($instagram = data_get($footer, 'instagram'))
                <a href="{{ $instagram }}"
                   target='_blank'
                 class="border border-1 hover:bg-white/20 transition-colors rounded-full p-[11px] gap-[10px] border-white/20">
                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
              ...
              @endif
              @if($linkedin = data_get($footer, 'linkedin'))
                <a href="{{ $linkedin }}"
                   target='_blank'
                 class="border border-1 hover:bg-white/20 transition-colors rounded-full p-[11px] gap-[10px] border-white/20">
                  <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
