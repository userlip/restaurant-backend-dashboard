<section class='mx-auto w-full max-w-[120rem]'>
  <div class="hero relative flex flex-col items-center self-stretch gap-[8.75rem] tablet:gap-[10rem] p-[3.75rem_0.875rem] tablet:p-[3.75rem_2.5rem] laptop:p-[3.75rem_4.375rem] min-h-[67.5rem] max-w-[100vw]">
    <header class="flex w-full justify-between items-center self-stretch">
      <div class="flex flex-col items-center">
        <span class="text-[2.5rem] text-white font-bold">LOGOTYPE</span>
      </div>
      <div class="flex items-center self-stretch tablet:gap-[1.25rem] big-tablet:gap-[2.5rem] laptop:gap-[5rem] desktop:gap-[7.5rem]">
        <div class="hidden big-tablet:flex items-center gap-[1.25rem] laptop:gap-[2.5rem] self-stretch">
          <a href="#about" class="p-[1rem_0rem] items-center justify-center gap-[0.625rem] text-white text-[1rem] laptop:text-[1.25rem] uppercase tracking-[0.03125rem] font-light hover:text-white/80 transition-colors">
            About Us
          </a>
          <a href="#menu" class="p-[1rem_0rem] items-center justify-center gap-[0.625rem] text-white text-[1rem] laptop:text-[1.25rem] uppercase tracking-[0.03125rem] font-light hover:text-white/80 transition-colors">
            Our Menu
          </a>
          <a href="#location" class="p-[1rem_0rem] items-center justify-center gap-[0.625rem] text-white text-[1rem] laptop:text-[1.25rem] uppercase tracking-[0.03125rem] font-light hover:text-white/80 transition-colors">
            Location
          </a>
        </div>
        <div class="hidden big-tablet:flex items-center gap-[0.875rem]">
          ...
          <div class="flex text-white flex-col items-start gap-[0.125rem]">
            <span class="text-[1.25rem] font-bold">+1 232 222 4445 777</span>
            <span class="font-inter font-light text-[0.625rem]">Mon - Fri: <span class="font-bold">09:00 - 23:00</span></span>
          </div>
        </div>
        <button class="hidden tablet:flex bg-white hover:bg-white/80 transition-colors text-primary text-[1rem] tracking-[0.03125rem] uppercase font-bold rounded-[3.8125rem] p-[1rem_2.5rem] justify-center items-center gap-[0.625rem]">
          Book a table
        </button>
    ...
    <div class="flex text-white big-tablet:justify-between big-tablet:items-center p-[0rem_1.25rem] laptop:p-[0rem_5rem] desktop:p-[0rem_8.125rem] flex-col big-tablet:flex-row items-end self-stretch justify-center gap-[5rem]">
      <div class="flex flex-col self-stretch items-center tablet:items-start tablet:gap-[3.3125rem] justify-end tablet:justify-normal">
        <div class="flex text-center tablet:text-left flex-col justify-center items-center tablet:items-start gap-[1.25rem] self-stretch">
          <span class="font-inter text-[1rem] tracking-[0.125rem]">BEST FOOD FOR YOU</span>
          <span class="text-[3.75rem] tablet:text-[5rem] desktop:text-[6.25rem] tracking-[-0.0625rem] uppercase">Restaurant Name</span>
          <span class="font-inter text-[1rem] leading-[170%] font-medium tracking-[0.0625rem] tablet:flex tablet:flex-col">Lorem ipsum dolor sit amet consectetur.<span>
                        Felis enim dictumst mauris volutpat in risus enim.</span></span>
        </div>
        <a href="#menu" class="hidden w-fit tablet:flex text-[1.25rem] text-white font-bold tracking-[0.03125rem] uppercase p-[1.25rem_2.5rem] justify-center items-center gap-[0.625rem] self-stretch rounded-[19.6875rem] bg-primary hover:bg-primary/80 transition-colors">
          OUR MENU
        </a>
      </div>
      <div class="hidden tablet:flex big-tablet:flex-col big-tablet:items-end big-tablet:justify-normal justify-end items-start gap-[1rem]">
        <a href="#" class="flex items-center justify-center h-[3.375rem] w-[3.375rem] bg-[rgba(255,255,255,0.20)] hover:bg-[rgba(255,255,255,0.10)] transition-colors p-[0.6875rem] gap-[0.625rem]">
    ...
    <a href="#menu" class="tablet:hidden flex text-[1.25rem] text-white font-bold tracking-[0.03125rem] uppercase p-[1.25rem_2.5rem] justify-center items-center gap-[0.625rem] self-stretch rounded-[19.6875rem] bg-primary hover:bg-primary/80 transition-colors">
      OUR MENU
    </a>
  ...
  <div id="drawer" class="flex bg-white tablet:my-auto flex-col big-tablet:hidden items-center justify-between p-[3.75rem_0.875rem] shrink-0 self-stretch fixed inset-0 h-[100dvh] w-screen z-40 transition-transform -translate-y-[150dvh] duration-300 ease-in-out">
    ...
    <div class="flex pt-[2.5rem] w-full flex-col items-center justify-center gap-[1.25rem]">
      <button id="button-about" class="flex font-light items-center justify-center p-[1rem_0rem] gap-[0.625rem] text-center text-alt hover:text-alt/80 transition-colors text-[1.25rem] uppercase tracking-[0.03125rem]">
        About Us
      </button>
      <button id="button-menu" class="flex font-light items-center justify-center p-[1rem_0rem] gap-[0.625rem] text-center text-alt hover:text-alt/80 transition-colors text-[1.25rem] uppercase tracking-[0.03125rem]">
        Our Menu
      </button>
      <button id="button-location" class="flex font-light items-center justify-center p-[1rem_0rem] gap-[0.625rem] text-center text-alt hover:text-alt/80 transition-colors text-[1.25rem] uppercase tracking-[0.03125rem]">
        Location
      </button>
    </div>
    <div class="flex flex-col justify-center self-stretch items-center gap-[1.25rem]">
      ...
      <div class="flex flex-col justify-center items-center self-stretch gap-[0.875rem]">
        ...
        <div class="flex flex-col justify-center items-center gap-[0.625rem]">
          <span class="text-[1.25rem] text-alt font-bold">+1 232 222 4445 777</span>
          <span class="font-light font-inter text-primary text-[0.875rem] tracking-[0.0625rem]">Mon. - Fri. : <span class="font-bold">09:00 - 23:00</span></span>
        </div>
      </div>
      <svg class="tablet:hidden" xmlns="http://www.w3.org/2000/svg" width="365" height="1" viewBox="0 0 365 1" fill="none">
        <path opacity="0.2" d="M365 0.5L-4.76837e-06 0.499984" stroke="#708086"/>
      ...
      <div class="flex flex-col justify-center items-center gap-[0.875rem]">
        ...
        <div class="flex flex-col justify-center items-center gap-[0.625rem]">
          <span class="text-[1.25rem] text-alt text-center font-bold">10408 Madison Street, Fort Lilly 19797-5951</span>
        </div>
      </div>
      <div class="flex justify-center items-center gap-[0.625rem] self-stretch">
        <div class="flex flex-col items-center gap-[0.625rem] flex-[1_0_0]">
          <span class="font-open text-[0.875rem] tracking-[0.0625rem] leading-[170%] text-center text-body">Mon - Fri</span>
          <span class="text-primary font-bold text-[1.25rem] tracking-[0.03125rem]">10:00 - 23:00</span>
        </div>
        ...
        <div class="flex flex-col items-center gap-[0.625rem] flex-[1_0_0]">
          <span class="font-open text-[0.875rem] tracking-[0.0625rem] leading-[170%] text-center text-body">Weekend</span>
          <span class="text-primary font-bold text-[1.25rem] tracking-[0.03125rem]">10:00 - 23:00</span>
        </div>
      </div>
      <svg class="tablet:hidden" xmlns="http://www.w3.org/2000/svg" width="365" height="1" viewBox="0 0 365 1" fill="none">
  ...
  <div id="about" class="flex tablet:justify-between self-stretch items-center tablet:pl-[2.5rem] big-tablet:pl-[3.75rem] laptop:pl-[9.375rem] desktop:pl-[23.125rem]">
    <div class="flex flex-col overflow-hidden items-center justify-center gap-[1.875rem] self-stretch p-[0rem_0.875rem_3.75rem_0.875rem]">
      <div class="flex flex-col items-center justify-center tablet:justify-normal tablet:items-start text-center tablet:text-left gap-[1.875rem] self-stretch">
        <h1 class="font-inter text-body uppercase tracking-[0.125rem] text-[0.875rem]">About Us</h1>
        <h2 class="self-stretch text-secondary mx-auto tablet:mx-0 text-[2.5rem] desktop:text-[3.75rem] tracking-[0.03125rem] leading-tight w-[360px] desktop:w-[500px] uppercase">Welcome to <span class="text-primary">Restaurant Name</span></h2>
      </div>
      ...
      <div class="flex flex-col big-tablet:flex-row pb-[1.25rem] gap-[1.25rem] self-stretch">
        <span class="font-open text-body text-[0.875rem] tracking-[0.0625rem] leading-[170%]">Lorem ipsum dolor sit amet consectetur. Gravida accumsan accumsan et lectus ipsum nulla erat. Sed dui vestibulum posuere massa vulputate. Enim volutpat amet enim venenatis pharetra. Eget accumsan massa amet faucibus.</span>
        <span class="font-open text-body text-[0.875rem] tracking-[0.0625rem] leading-[170%]">Lorem ipsum dolor sit amet consectetur. Gravida accumsan accumsan et lectus ipsum nulla erat. Sed dui vestibulum posuere massa vulputate. Enim volutpat amet enim venenatis pharetra. Eget accumsan massa amet faucibus.</span>
      </div>
      <a href="#menu" class="tablet:w-fit flex text-[1.25rem] text-white font-bold tracking-[0.03125rem] uppercase p-[1.25rem_2.5rem] justify-center items-center gap-[0.625rem] self-stretch rounded-[19.6875rem] bg-primary hover:bg-primary/80 transition-colors">
        OUR MENU
      </a>
    </div>
  ...
  <div class="about text-white flex min-h-[56.375rem] tablet:min-h-[50rem] flex-col p-[16rem_0.875rem] tablet:p-[16rem_3.75rem] laptop:p-[16rem_9.375rem] desktop:p-[16rem_23.125rem] justify-center tablet:justify-end tablet:items-end items-center gap-[0.625rem] self-stretch">
    <div class="flex gap-[3.75rem] tablet:flex-initial flex-[1_0_0] max-w-[43.75rem] tablet:w-[30.75rem] flex-col items-start">
      ...
      <div class="flex flex-col tablet:flex-row gap-[1.25rem] items-center tablet:justify-start justify-center self-stretch">
        <button class="tablet:w-fit flex text-[1.25rem] text-white font-bold tracking-[0.03125rem] uppercase p-[1.25rem_2.5rem] justify-center items-center gap-[0.625rem] self-stretch rounded-[19.6875rem] bg-primary hover:bg-primary/80 transition-colors">
          BOOK A TABLE
        </button>
  ...
  <div id="menu" class="relative flex items-center justify-center p-[3.75rem_0.875rem] tablet:p-[3.75rem_2.5rem] laptop:p-[6.25rem_9.375rem] desktop:p-[6.25rem_23.125rem] self-stretch">
    ...
    <div class="flex flex-col justify-center items-center flex-[1_0_0] gap-[5rem]">
      <div class="flex flex-col items-center self-stretch text-center gap-[1.875rem]">
        <h1 class="font-inter text-body tracking-[0.3125rem] uppercase">Explore</h1>
        <h2 class="text-secondary text-[2.5rem] desktop:text-[3.75rem] tracking-[0.03125rem]">Our Menu</h2>
      </div>
      ...
      <button href="#menu" class="z-10 w-fit mx-auto flex text-[1.25rem] text-white font-bold tracking-[0.03125rem] uppercase p-[1.25rem_2.5rem] justify-center items-center gap-[0.625rem] self-stretch rounded-[19.6875rem] bg-primary hover:bg-primary/80 transition-colors">
        Download Menu (PDF)
      </button>
    </div>
  </div>
  <div class="flex flex-col items-center self-stretch pb-[3.75rem] overflow-hidden">
    ...
    <div class="flex mt-[-39.5rem] z-10 flex-col justify-center items-center self-stretch gap-[4.25rem] p-[6.25rem_0.875rem_0rem_0.875rem] tablet:p-[6.25rem_2.5rem_0rem_2.5rem] big-tablet:p-[6.25rem_3.75rem_0rem_3.75rem] laptop:p-[6.25rem_9.375rem_0rem_9.375rem] desktop:p-[6.25rem_23.125rem_0rem_23.125rem]">
      ...
      <div class="flex flex-col bg-white p-[1.25rem] tablet:p-[3.75rem] gap-[2.5rem] tablet:gap-[3.75rem] self-stretch">
        <div class="flex flex-col items-start gap-[1.25rem] self-stretch">
          <div class="flex tablet:flex-row flex-col items-start gap-[0.625rem] self-stretch">
            <div class="flex flex-1 flex-col gap-[0.625rem] self-stretch">
              <label for="name" class="text-alt font-inter leading-[120%] tracking-[0.0625rem] text-[0.75rem]">Full Name</label>
            ...
            <div class="flex flex-1 flex-col gap-[0.625rem] self-stretch">
              <label for="email" class="text-alt font-inter leading-[120%] tracking-[0.0625rem] text-[0.75rem]">Enter Your Email</label>
              <div class="flex self-stretch flex-[1_0_0] w-full justify-between items-center p-[0.625rem_0.875rem] bg-[#F2F3F7] ">
          ...
          <div class="flex flex-col gap-[0.625rem] items-start self-stretch">
            <label for="message" class="text-alt font-inter leading-[120%] tracking-[0.0625rem] text-[0.75rem]">Message</label>
        ...
        <button class="tablet:w-fit tablet:mx-auto flex text-[1.25rem] text-white font-bold tracking-[0.03125rem] uppercase p-[1.25rem_2.5rem] justify-center items-center gap-[0.625rem] self-stretch rounded-[19.6875rem] bg-primary hover:bg-primary/80 transition-colors">
          SENT
        </button>
        <p class="text-body text-center mx-auto font-open text-[0.875rem] tracking-[0.0625rem] leading-[170%] tablet:flex tablet:flex-col">Lorem ipsum dolor sit amet consectetur. Gravida accumsan <span>accumsan et lectus ipsum nulla erat.</span></p>
      </div>
    </div>
  </div>
  ...
  <footer class="flex p-[3.75rem_0.875rem] tablet:p-[3.75rem_2.5rem] laptop:p-[3.75rem_5rem] desktop:p-[3.75rem_12.5rem] flex-col items-center gap-[1.875rem] self-stretch">
    <div class="flex flex-col big-tablet:flex-row items-center justify-center big-tablet:justify-between gap-[2.5rem] big-tablet:gap-0 self-stretch">
      <div class="flex flex-col big-tablet:flex-row items-center justify-center gap-[0.875rem]">
        ...
        <div class="flex flex-col text-center items-center gap-[0.125rem]">
          <span class="font-bold text-alt text-[1.675rem]">+1 232 222 4445 777</span>
          <span class="font-inter font-thin text-alt text-[0.875rem]">Mon. - Fri. : <span class="font-bold">09:00 - 23:00</span></span>
        </div>
      </div>
      <span class="text-[3.125rem] font-bold upppercase text-center text-alt">LOGOTYPE</span>
      <div class="flex gap-[1rem]">
        <a href="#" class="border flex items-center justify-center h-[3.375rem] w-[3.375rem] border-1 hover:bg-[rgba(84,108,118,0.30)] transition-colors p-[0.6875rem] gap-[0.625rem] border-[rgba(84,108,118,0.30)]">
          <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
            <path d="M16.5 9.04277C16.5 5.15316 13.366 2 9.5 2C5.634 2 2.5 5.15316 2.5 9.04277C2.5 12.558 5.05979 15.4716 8.40625 16V11.0786H6.62891V9.04277H8.40625V7.49116C8.40625 5.72607 9.45135 4.75108 11.0502 4.75108C11.8162 4.75108 12.6172 4.88864 12.6172 4.88864V6.62183H11.7345C10.865 6.62183 10.5938 7.16475 10.5938 7.72173V9.04277H12.5351L12.2248 11.0786H10.5938V16C13.9402 15.4716 16.5 12.5581 16.5 9.04277Z" fill="#546C76"/>
    ...
    <div class="flex w-full items-center justify-center gap-[2.5rem] self-stretch">
      <a href="#about" class="text-[1.25rem] tracking-[0.03125rem] uppercase p-[1rem_0rem] justify-center items-center self-stretch gap-[0.625rem] text-primary hover:text-primary/80 transition-colors">About Us</a>
      <a href="#menu" class="text-[1.25rem] tracking-[0.03125rem] uppercase p-[1rem_0rem] justify-center items-center self-stretch gap-[0.625rem] text-primary hover:text-primary/80 transition-colors">Our Menu</a>
      <a href="#location" class="text-[1.25rem] tracking-[0.03125rem] uppercase p-[1rem_0rem] justify-center items-center self-stretch gap-[0.625rem] text-primary hover:text-primary/80 transition-colors">Location</a>
    </div>
    <p class="text-body font-open text-center font-[0.875rem] leading-[170%] tracking-[0.0625rem] tablet:flex tablet:flex-col">Lorem ipsum dolor sit amet consectetur. Gravida accumsan <span>accumsan et lectus ipsum nulla erat.</span></p>
  </footer>
</section>
