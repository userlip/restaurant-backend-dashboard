...
use App\Filament\Resources\TemplateOneMediaPickerResource\Pages;
use App\Filament\Resources\TemplateOneMediaPickerResource\RelationManagers;
use App\Models\TemplateOneMediaPicker;
...
class TemplateOneMediaPickerResource extends Resource
{
                                ...
                                Block::make('header')
                                    ->schema([
                                        Section::make('Header')
                                            ->collapsible()
                                            ->schema([
                                                CuratorPicker::make('header_logo')
                                    ...
                                    ->schema([
                                        ...
                                        Section::make('Left Section')
                                            ->schema([
                                                ...
                                                CuratorPicker::make('left_image')
                                                    ->directory('template-1')
                                                    ->hint('9:16 images'),

                                                CuratorPicker::make('right_image')
                                                    ->directory('template-1')
                                                    ->hint('9:16 images'),
                                            ]),
                                    ...
                                    ->schema([
                                        ...
                                        Section::make('Right Section')
                                            ->schema([
                                                ...
                                                CuratorPicker::make('menu_picture')
                                                    ->directory('template-1'),
                                            ])
                                    ]),
...
//                                    ]),
    ...
    {
        return [
            'index' => Pages\ListTemplateOneMediaPickers::route('/'),
            'create' => Pages\CreateTemplateOneMediaPicker::route('/create'),
            'edit' => Pages\EditTemplateOneMediaPicker::route('/{record}/edit'),
        ];
    }
}
